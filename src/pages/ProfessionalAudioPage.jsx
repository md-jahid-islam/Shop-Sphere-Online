  ...
  return (
    <>
      ...
      <section className="bg-black text-white py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-400 max-w-xl mx-auto mb-6">
            Trusted by studios, stages & venues worldwide.
          </p>
      ...
      <section className="py-12 px-4 bg-gray-100">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {[
            ...
            >
              <h3 className="font-semibold text-gray-800">{use}</h3>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-orange-500 text-white py-14 text-center px-4">
        ...
        <p className="mb-6">
          Industry-leading sound solutions for professionals.
        </p>
